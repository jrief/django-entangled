...
def test_sorted_form():
    ...
    expected = BeautifulSoup("""
        ...
        <li><label for="id_name">Name:</label> <input type="text" name="name" required id="id_name"></li>""", features='lxml')
    assert BeautifulSoup(product_form.as_ul(), features='lxml') == expected
...
def test_simple_inheritance_unsorted():
    ...
    expected = BeautifulSoup("""
        ...
        <li><label for="id_author">Author:</label> <input type="text" name="author" required id="id_author"></li>""", features='lxml')
    assert BeautifulSoup(product_form.as_ul(), features='lxml') == expected
...
def test_multiple_inheritance_unsorted():
    ...
    expected = BeautifulSoup("""
        ...
        <li><label for="id_unit">Unit:</label> <input type="text" name="unit" required id="id_unit"></li>""", features='lxml')
    assert BeautifulSoup(product_form.as_ul(), features='lxml') == expected
